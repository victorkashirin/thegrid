...
class PluginDataParser:
    ...
    def process_tags(self, tags: List[str]) -> List[str]:
        """
        Process and clean up tags for a module.
        ...
        def capitalise(s: str) -> str:
            ...
            mapping = {
                ...
                'Utilities, delay': 'Utility',
                'Drums': 'Drum',
                'Eq': 'Equalizer',
                'Tool': 'Utility',
                'Mixer, utilities': 'Utility',
                'Utilities': 'Utility',
            }
            return mapping.get(result, result)

        cleaned_tags = [capitalise(tag) for tag in tags if tag]
    ...
    def _create_module_info(self, plugin_name: str, plugin_slug: str, module: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "tags": self.process_tags(module.get("tags", [])),
        }
